...
def test_parser():
    ...
    parser.add_argument('--use_cav', type=str, default="[4]", #default was [1,2,3,4]
...
def main():
    ...
    if hypes['heter']['assignment_path'] is not None:
    ...
    for (use_cav, lidar_config) in use_cav_and_lidar_config_pair:
        ...
        if lidar_config is not None:
            ...
            print("Hypes parameters for loading the dataset!")
            print(hypes['use_cav'])
