            ...
            for (j, cav_id) in enumerate(cav_list):
                ...
                for timestamp in timestamps:
                    ...
                    if getattr(self, "heterogeneous", False):
                        ...
                        # enable multi-modality per agent
                        if "all_modality" in self.params and self.params['all_modality'] == True:
                            self.scenario_database[i][cav_id][timestamp]['modality_name'] = 'm1&m2'
    ...
    def retrieve_base_data(self, idx):
        ...
        for cav_id, cav_content in scenario_database.items():
            ...
            if getattr(self, "heterogeneous", False):
                ...
                if "all_modality" in self.params and self.params['all_modality'] == True:
                    cav_content[timestamp_key]['modality_name'] = 'm1&m2'
                    data[cav_id]['modality_name'] = 'm1&m2'
