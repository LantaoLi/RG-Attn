...
def getIntermediateheterallinferFusionDataset(cls):
    """
    cls: the Basedataset.
    """
    Intermediate_heterall_Fusion_Dataset = getIntermediateheterallFusionDataset(cls)

    class Intermediate_heterall_Infer_Fusion_Dataset(Intermediate_heterall_Fusion_Dataset):
        """
        We add 'use_cav' to control the number of cars that really participate in collaboration.
        We use 'max_cav' to genenrate all gt boxes in the scene.
        """
        def __init__(self, params, visualize, train=True):
            ...
            print("Otherwise, modify it in opencood/data_utils/datasets/heter_infer/intermediate_heterall_infer_fusion_dataset.py\n\n")
        ...
        def __getitem__(self, idx):
            ...
            cav_num = len(cav_id_list)#was len(agent_modality_list)
    ...
    return Intermediate_heterall_Infer_Fusion_Dataset
